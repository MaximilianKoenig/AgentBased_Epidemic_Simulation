...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns="http://repast.sf.net/statecharts" xmlns:notation="http://www.eclipse.org/gmf/runtime/1.0.2/notation">
  <StateMachine xmi:id="_iNvQ0bMPEeqM7vXeYvDqVw" agentType="agentBased_Epidemic_Simulation.Person" package="agentBased_Epidemic_Simulation.chart" className="InfectionState" nextID="136" id="InfectionState" uuid="_iNvQ0LMPEeqM7vXeYvDqVw">
    ...
    <transitions xmi:type="Transition" xmi:id="_GWtqILMQEeqM7vXeYvDqVw" from="_5csDsLMPEeqM7vXeYvDqVw" to="_-cT_YLMPEeqM7vXeYvDqVw" triggerType="timed" messageCheckerClass="Object" id="Transition 9" triggerTimedCode="agent.getLatentTime() * Scenario.daysToTicks;" triggerTimedCodeImports="" uuid="_GWuRMLMQEeqM7vXeYvDqVw"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_Lfx1sLMQEeqM7vXeYvDqVw" from="_CXDWoLMQEeqM7vXeYvDqVw" to="_BAE8oLMQEeqM7vXeYvDqVw" triggerType="timed" messageCheckerClass="Object" id="Transition 12" triggerTimedCode="(agent.getIncubationTime() - agent.getLatentTime()) * Scenario.daysToTicks;" uuid="_Lfx1sbMQEeqM7vXeYvDqVw"/>
    ...
    <transitions xmi:type="Transition" xmi:id="_x9zlYLMREeqM7vXeYvDqVw" from="_BAE8oLMQEeqM7vXeYvDqVw" to="_XsGooLMQEeqM7vXeYvDqVw" onTransition="agent.getContext().infectionsTotal --;" triggerType="timed" messageCheckerClass="Object" id="Transition 27" triggerTimedCode="agent.getPostSymptomaticInfectiousDuration() * Scenario.daysToTicks;" triggerTimedCodeImports="import repast.simphony.random.RandomHelper;" uuid="_x9zlYbMREeqM7vXeYvDqVw"/>
  </StateMachine>
