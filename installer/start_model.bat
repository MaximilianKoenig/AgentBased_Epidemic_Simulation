@ECHO OFF
TITLE AgentBased_Epidemic_Simulation
...
CD AgentBased_Epidemic_Simulation

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./AgentBased_Epidemic_Simulation.rs
